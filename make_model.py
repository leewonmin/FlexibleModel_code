...
class innerproduct(torch.nn.Module):
    ...
    def forward(self, output1, output2, f_concate_rep, label, weight_, device):
        ...
        for i in range(len(gumbel_result)):                
            if gumbel_result[i][0]==1. and gumbel_result[i][1]==0.:
                sigmoid[i] = sigmoid1[i]
            elif gumbel_result[i][0]==0. and gumbel_result[i][1]==1.:
                sigmoid[i] = sigmoid2[i]
