...
#trainset = np.load('./' + args.ds + '/trainset_warm.npy')
...
#pkl_file = open('./'+fpath+'/val_grtr_warm.pkl', 'rb')
...
for epoch in range(0, num_epochs):
    ...
    for batch_num in range(num_iters):
        #count_usertower1_inbatch=0
        #count_usertower2_inbatch=0
        ...
        #count_usertower1+=count_usertower1_inbatch
        #count_usertower2+=count_usertower2_inbatch


    # print('count_usertower1,2: ', count_usertower1, count_usertower2)
    # print('portion of usertower1, usertower2: ', count_usertower1/(count_usertower1+count_usertower2), count_usertower2/(count_usertower1+count_usertower2))
